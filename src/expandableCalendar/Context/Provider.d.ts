...
declare const CalendarProvider: {
    ...
    propTypes: {
        ...
        todayButtonStyle: PropTypes.Requireable<NonNullable<number | object | null | undefined>>;
        disabledOpacity: PropTypes.Requireable<number>;
        numberOfDays: PropTypes.Requireable<number>;
        timelineLeftInset: PropTypes.Requireable<number>;
    };
};
