...
export default class ExpandableCalendarScreen extends Component {
    ...
    render() {
        return (<CalendarProvider date={ITEMS[1].title} onDateChanged={this.onDateChanged} onMonthChange={this.onMonthChange} showTodayButton disabledOpacity={0.6} theme={this.todayBtnTheme}>
        {this.props.weekView ? (<WeekCalendar testID={testIDs.weekCalendar.CONTAINER} firstDay={1} markedDates={this.marked}/>) : (<ExpandableCalendar testID={testIDs.expandableCalendar.CONTAINER} 
            ...
            firstDay={1} markedDates={this.marked} leftArrowImageSource={leftArrowIcon} rightArrowImageSource={rightArrowIcon}/>)}
